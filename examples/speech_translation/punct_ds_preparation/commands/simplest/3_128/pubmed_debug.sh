python prepare_big_data_for_punctuation_capitalization_task_simple.py \
  --output_dir /media/apeganov/DATA/punctuation_and_capitalization/simplest/3_128/pubmed_x1_03.05.2022_debug \
  --corpus_types pubmed \
  --create_model_input \
  --bert_labels \
  ...
  --input_files_or_dirs /media/apeganov/DATA/pubmed_OA_commercial/tmp \
  --num_jobs 24 \
