...
model.train_ds.manifest_filepath=/mnt/data/wsj/wsj0-2mix/manifests/tr_tsasr.json \
trainer.max_epochs=50 \
num_sources=2 \
model.validation_ds.manifest_filepath=/mnt/data/wsj/wsj0-2mix/manifests/cv_tsasr.json \
model.train_ds.max_duration=16 \
model.train_ds.mixing_portion=0 \
model.tokenizer.type=bpe \
trainer.num_sanity_val_steps=0 \
model.test_ds.manifest_filepath=/mnt/data/wsj/wsj0-2mix/manifests/tt_tsasr.json \
