...
from nemo.collections.nlp.models.machine_translation.mt_enc_dec_bottleneck_model import MTHierarBottleneckModel
...
def main(cfg: MTBlockBottleneckConfig) -> None:
    ...
    mt_model = MTHierarBottleneckModel(cfg.model, trainer=trainer)
