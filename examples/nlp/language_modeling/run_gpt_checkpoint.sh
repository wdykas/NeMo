TORCH_DISTRIBUTED_DEBUG=DETAIL HYDRA_FULL_ERROR=1 torchrun --nnode 1 --nproc_per_node 4 megatron_gpt_pretraining.py \
    ...
    model.resume_from_checkpoint=/workspace/checkpoint-nemo/NeMo/examples/nlp/language_modeling/gpt-checkpoint/megatron_gpt--val_loss=8.42-step=100-consumed_samples=1584.0.ckpt \
